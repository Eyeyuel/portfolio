...
const Footer = () => {
  return (
    <Card className="w-full bg-transparent shadow-none rounded-none border-0 border-t-2 overflow-x-hidden">
      <div className="flex flex-row justify-between lg:px-40">
        ...
        <CardContent className="flex justify-center align-center flex-col space-y-3 p-0 pr-5">
          <CardTitle className="self-center">Media</CardTitle>
